...
import { Link2, MousePointerClick, Play, Users } from 'lucide-react';
  ...
  const stats = [
    {
      ...
      glow: 'shadow-[0_0_12px_-2px_rgba(168,85,247,0.3)]',
    ...
    {
      label: 'Сценариев',
      value: data?.totalScenarioRuns ?? 0,
      icon: Play,
      color: 'text-neon-amber',
      glow: 'shadow-[0_0_12px_-2px_rgba(251,191,36,0.3)]',
      bg: 'bg-neon-amber/10',
    },
  ];
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0">
                <div
                  className={cn(
                    'font-bold text-lg leading-none tabular-nums',
                    stat.color,
                  )}
                >
                  {inView ? (
                ...
                <p className="text-[10px] text-th/30 mt-0.5 leading-tight truncate">
                  {stat.label}
                </p>
              </div>
            </div>
